...
(Shuffle ArrayList) 
Write the following method that shuffles the elements in an ArrayList of integers and checks all the values are present in the list.

```java
public static void shuffle(ArrayList<Integer> list)

public class ShuffleARRList {
